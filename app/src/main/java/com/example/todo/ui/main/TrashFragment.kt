...
import com.example.todo.data.model.Result
...
class TrashFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val sp = activity?.getSharedPreferences("com.example.todo_preferences", 0)
        ...
        emptyNotesImageView.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.ic_outline_delete_24, activity?.theme))
        emptyNotesTextView.text = "No Trash Notes"
